// Copy from https://github.com/denoland/deno_std/
// Thanks to https://github.com/denoland/deno_std/

import { listen, Conn, toAsyncIterator, Reader, copy } from "deno";
import { BufReader, BufState, BufWriter } from "./bufio";
    ...
    if (this.headers.has("content-length")) {
      ...
      if (this.headers.has("transfer-encoding")) {
        ...
        if (transferEncodings.includes("chunked")) {
          ...
          const [chunkSizeString, optExt] = line.split(";");
          ...
          while (chunkSize > 0) {
            ...
            const [nread, err] = await this.r.readFull(data);
            if (nread !== chunkSize) {
